...
/**
 * Early POC for a radial light and visibility check but does not work great.
 * It currently checks visibility from block center to eye (which is also at
 * block center) but that check isn't good enough, if you are close to a wall
 * then some blocks are obscured, it would need to check each corner of the
 * block to the eye position.
 */
